...
- (void)viewDidLoad {
    ...
    //Dont Forget to turn off Clip Subviews for the scroll view. This will allow it to draw outside of its view, which is important for the peeking of pages
...
- (void)loadPage:(NSInteger)page {
    ...
    if ((NSNull*)pageView == [NSNull null]) {
        ...
        frame.origin.y = 0.0f;
        frame = CGRectInset(frame, 10.0f, 0.0f);    // Magic Happens Here
